        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.estadisticas:
                    Intent intent3 = new Intent (ajustes.this, estadisticas.class);
                    startActivityForResult(intent3, 0);
                    return true;
                case R.id.time:
                    Intent intent4 = new Intent (ajustes.this, top_tiempos.class);
                    startActivityForResult(intent4, 0);
                    return true;
                case R.id.settings:
                    Intent intent5 = new Intent (ajustes.this, ajustes.class);
